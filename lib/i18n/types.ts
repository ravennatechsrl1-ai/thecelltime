...
export interface Translations {
  ...
  admin: {
    ...
    orderMarkProcessing: string;
    orderMarkShipped: string;
    orderMarkDelivered: string;
    orderCancel: string;
    orderItems: string;
    orderShippingAddress: string;
    orderNoShipping: string;
    ...
    catalogPanelDesc: string;
    catalogTabHint: string;
    manageConditions: string;
    ...
    storageDesc: string;
    colorsDesc: string;
    modelsMobilesDesc: string;
    seriesDesc: string;
    modelsDeviceDesc: string;
    conditionsEmpty: string;
    storageEmpty: string;
    colorsEmpty: string;
    modelsEmpty: string;
    seriesEmpty: string;
    ...
    conditionShopGroup: string;
    conditionShopNew: string;
    conditionShopUsed: string;
    seriesLabel: string;
    phoneModel: string;
    phoneStorage: string;
    phoneColor: string;
    ...
    unfreezeProduct: string;
    productFrozenBadge: string;
    filterVisibility: string;
    filterVisibilityAll: string;
    filterVisibilityVisible: string;
    filterVisibilityFrozen: string;
    ...
    brandsPanelDesc: string;
    brandsMobilesDesc: string;
    brandsProtectionDesc: string;
    brandsAccessoriesDesc: string;
    brandsList: string;
    brandsEmpty: string;
    brandsTabHint: string;
    addModel: string;
    addCondition: string;
    addStorage: string;
    addSeries: string;
    ...
    promotionStripTitle: string;
    promotionStripDesc: string;
    promotionStripTextIt: string;
    promotionStripTextEn: string;
    promotionStripPlaceholderIt: string;
    promotionStripPlaceholderEn: string;
    promotionStripEnabled: string;
    promotionStripPreview: string;
    promotionStripSave: string;
    promotionStripSaved: string;
    promotionStripError: string;
